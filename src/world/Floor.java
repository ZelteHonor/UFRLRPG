...
public class Floor {
	...
	/**
	 * G�n�re un �tage � la profondeur depth
	 * 
	 * @param depth
	 */
	...
	/**
	 * 
	 * @return renvoi le point d'entr� de l'�tage en x
	 */
	...
	/**
	 * 
	 * @return renvoi le point d'entr� de l'�tage en y
	 */
	...
	/**
	 * 
	 * @return renvoi le point de sortie de l'�tage en x
	 */
	...
	/**
	 * 
	 * @return renvoi le point de sortie de l'�tage en y
	 */
